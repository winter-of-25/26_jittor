...
from stable_expert_moe_v61 import patch_based_v61_pair
...
class FullCloudValidationSuite:
    """Fixed 50k-cloud validation using the submission inference path."""
    ...
    def evaluate(
        ...
        return {
            ...
            "active_refinement_strength": float(
                best_active
            ),
